...
class TestEnums:
    ...
    def test_emotion_values(self) -> None:
        ...
        assert Emotion.CONTEMPLATIVE.value == "contemplative"
        assert Emotion.THOUGHTFUL.value == "thoughtful"
        assert Emotion.GRATEFUL.value == "grateful"
        assert Emotion.VULNERABLE.value == "vulnerable"
        assert Emotion.CONTENT.value == "content"
        assert Emotion.FULFILLED.value == "fulfilled"
        assert Emotion.TOUCHED.value == "touched"
        assert Emotion.CONCERNED.value == "concerned"
        assert Emotion.HOPEFUL.value == "hopeful"
        assert Emotion.PEACEFUL.value == "peaceful"
        assert Emotion.LOVE.value == "love"
        assert Emotion.WARM.value == "warm"
        assert Emotion.LONELY.value == "lonely"
        assert Emotion.AFRAID.value == "afraid"
        assert Emotion.ASHAMED.value == "ashamed"
        assert Emotion.BORED.value == "bored"
